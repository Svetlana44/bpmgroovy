...
/*
    ...
    request.CookieContainer = _authCookie;
                // При успешной аутентификации сохраняем аутентификационные куки для дальнейшего использования в запросах к системе.
                string authName = ".ASPXAUTH";
                string authCookeValue = response.Cookies[authName].Value;
                _authCookie.Add(new Uri(_appUrl), new Cookie(".ASPXAUTH", authCookeValue));
